...
export class ControlHelpService {
  ...
  uiPanelControlHelpMap: Map<UiPanel, Array<ControlPanelItem>> = new Map([
    [
      UiPanel.PHOTO,
      [
        {
          button: 'Left Dpad',
          label: 'Show previous photo / Return to main view',
        },
    ...
    [
      ...
      [
        {
          button: 'Up Dpad',
          label: 'Go to previous parameter / Return to main view',
        },
    ...
    [
      ...
      [
        {
          button: 'Down Dpad',
          label: 'Go to next parameter / Return to main view',
        },
